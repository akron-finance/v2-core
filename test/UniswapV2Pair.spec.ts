...
describe('UniswapV2Pair', () => {
  ...
  const swapTestCases: BigNumber[][] = [
    [1, 5, 10, '1428571428571428571'], // has to be less than 1662497915624478906
    [1, 10, 5, '416666666666666666'], // has to be less than 453305446940074565

    [2, 5, 10, '2222222222222222222'], // has to be less than 2851015155847869602
    [2, 10, 5, '714285714285714285'], // has to be less than 831248957812239453

    [1, 10, 10, '833333333333333333'], // has to be less than 906610893880149131
    [1, 100, 100, '980392156862745098'], // has to be less than 987158034397061298
    [1, 1000, 1000, '998003992015968063'] // has to be greater than 996006981039903216
  ...
  swapTestCases.forEach((swapTestCase, i) => {
    it(`getInputPrice:${i}`, async () => {
      ...
      await expect(pair.swap(0, expectedOutputAmount.add(1), wallet.address, '0x', overrides))
        .to.be.revertedWith('K') // e.g. 1428571428571428571 + 1
      await pair.swap(0, expectedOutputAmount, wallet.address, '0x', overrides) // e.g. 1428571428571428571
    })
  })

  const optimisticTestCases: BigNumber[][] = [
    ['1000000000000000000', 5, 10, 1],
    ['1000000000000000000', 10, 5, 1],
    ['1000000000000000000', 5, 5, 1],
    [1, 5, 5, '1000000000000000000'] 
  ...
  it('swap:token0', async () => {
    ...
    const expectedOutputAmount = bigNumberify('1428571428571428571')
  ...
  it('swap:token1', async () => {
    ...
    const swapAmount = expandTo18Decimals(1)
    const expectedOutputAmount = bigNumberify('416666666666666666')
  ...
  it('swap:gas', async () => {
    ...
    expect(receipt.gasUsed).to.eq(93911)
